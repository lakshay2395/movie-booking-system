...
RSpec.describe User, type: :model do
  ...
  let(:user_two) do
    User.new(id: 101, first_name: "Srishty", last_name: "Bhambri", email_id: "srishty2698@gmail.com", password: "5678")
  end

  let(:user_with_duplicate_email) do
    User.new(id: 102, first_name: "Lakshay", last_name: "Bhambri", email_id: "bhambri.lakshay.lakshay@gmail.com", password: "1234")
  end
  ...
  it "is not valid without password" do
    user = User.new(email_id: "bhambri.lakshay@gmail.com", password: nil)
    expect(user).to_not be_valid
  end
